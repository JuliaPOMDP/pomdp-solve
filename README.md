...
### _2023-12-22_
     ...
     * src/signal-handler.c: Modified signal handler to work on non POSIX systems (windows)
     ...
     * src/xalloc.c and src/xalloc.h: Added declaration for rpl_malloc and rpl_realloc. These were not defined and causing compile errors with MacOS using a GNU compiler.
